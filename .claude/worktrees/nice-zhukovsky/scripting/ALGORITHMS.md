...
This is a living document. Update it as new algorithms are implemented or existing ones evolve. Each system is described in terms of what it does, its ScriptNode header, a skeleton implementation, and how it chains with other systems.
...
2. Include the ScriptNode header, skeleton implementation, and chaining notes
3. Update `PROJECT_CONTEXT.md` if the new system changes the design direction
4. Add example scripts to `examples/`
