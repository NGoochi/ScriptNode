...
namespace ScriptNodePlugin
{
    ...
    /// </summary>
    public class LegacyDataNode : GH_Component, IGH_VariableParameterComponent
    {
        // ── State ─────────────────────────────────────────────────
        ...
        /// <summary>Hidden — kept only for loading old .gh files; use Alien instead.</summary>
